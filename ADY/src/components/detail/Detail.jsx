        ...
        <div className='w-full lg:px-26 md:px-16 sm:px-7 px-4 mt-[5ch] mb-[10ch]'>
            <div className="w-full grid grid-cols-2 gap-16 items-center">
                ...
                <div className="col-span-1 space-y-10">
                    ...
                    <div className="flex">
                        <Link to={'/checkout'} className='w-fit bg-violet-600 text-neutral-50 font-medium text-base px-6 py-2 rounded-md hover:bg-violet-700 ease-in-out duration-300 ml-8'>
                            {t("buy")}
                        </Link>
                    </div>
                </div>
